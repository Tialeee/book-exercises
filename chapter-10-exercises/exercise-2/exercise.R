...
salaries$salary_went_up <- salaries$adjustments > 0 
...
nrow(salaries[ salaries$salary_went_up == TRUE, ])
...
# paycut <- salaries[ salaries$salaries_went_up == FALSE, ]
mean(salaries[ salaries$salaries_went_up == FALSE, "adjustments"])
